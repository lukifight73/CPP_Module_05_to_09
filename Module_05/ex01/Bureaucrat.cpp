...
Bureaucrat::Bureaucrat(): m_name("default Bureaucrat"), m_grade(150)
{
...
Bureaucrat::Bureaucrat(int i): m_name("default Bureaucrat")
{
...
void Bureaucrat::signForm(Form m)
{
	m.beSigned(*this);
}
...
std::ostream	&operator<<(std::ostream &o, Bureaucrat const &Bureaucrat)
{
	...
	o << Bureaucrat.getName() << ", bureaucrat grade : " << Bureaucrat.getGrade() << std::endl << std::endl;
	return (o);
}
